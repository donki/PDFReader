...
public class LocalizationService : ILocalizationService
{
    ...
    private static Dictionary<string, string> BuildSpanish() => new()
    {
        ...
        ["contact_hint"] = "Toca para enviar un correo",
        ...
        ["license_text"] = "PDF Reader es software libre bajo licencia MIT. Puedes usarlo, copiarlo, modificarlo y distribuirlo conservando el aviso de copyright.",
        ["privacy_title"] = "🔒 Privacidad",
        ["privacy_text"] = "La aplicación no pide ningún permiso, no accede a internet y no envía datos a ningún servidor. Los documentos que abres se copian a la carpeta privada de la app en tu dispositivo y nadie más puede leerlos.",
        ["legal_title"] = "⚖️ Aviso legal",
        ["legal_text_1"] = "Este software se proporciona «tal cual», sin garantías de ningún tipo. El usuario es responsable del uso adecuado de la aplicación.",
        ["legal_text_2"] = "En ningún caso los autores serán responsables de daños directos, indirectos o derivados del uso de este software.",
    ...
    private static Dictionary<string, string> BuildEnglish() => new()
    {
        ...
        ["license_text"] = "PDF Reader is free software under the MIT license. You may use, copy, modify and distribute it while keeping the copyright notice.",
        ["privacy_title"] = "🔒 Privacy",
        ["privacy_text"] = "The app requests no permissions, has no internet access and sends no data to any server. Documents you open are copied into the app's private folder on your device, where nobody else can read them.",
        ["legal_title"] = "⚖️ Legal notice",
        ["legal_text_1"] = "This software is provided \"as is\", without warranties of any kind. The user is responsible for the proper use of the application.",
        ["legal_text_2"] = "In no event shall the authors be liable for direct, indirect or consequential damages resulting from the use of this software.",
